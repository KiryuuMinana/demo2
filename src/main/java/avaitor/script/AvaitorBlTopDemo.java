 ...
 *
 */
public class AvaitorBlTopDemo {
	public static void main(String[] args) throws IOException {
		// 定义 Aviator 脚本

		String scriptPath = "D:\\Glodon-work\\idea-workspace\\demo2\\src\\main\\java\\avaitor\\av\\bl_top.av";
...
//        yourPLList.add(BidderIdPriceBO.builder().bidderId("00001").price(new BigDecimal(500)).build());
		...
		env.put("list", yourPLList); // 替换为您的 PL 列表
		env.put("n", 0); // 替换为您的 MBPL 值
