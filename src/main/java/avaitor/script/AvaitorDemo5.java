...
/**
 * 看看H001-01-24和我写的H001-01-29有啥区别
 * 测试这个是不是过滤了一个值就break了
 *
 * @author 沈航冉
 * @date 2023-12-12 15:17:22
 */
public class AvaitorDemo5 {
	public static void main(String[] args) throws IOException {
		// 定义 Aviator 脚本

		String scriptPath = "D:\\Glodon-work\\idea-workspace\\demo2\\src\\main\\java\\avaitor\\av\\f_filter_value.av";
